...
class Character:
    ...
    def defence(self):
        """Метод защиты."""
        defence = DEFAULT_DEFENCE + randint(*self.RANGE_VALUE_DEFENCE)
        return (f'{self.name} блокировал {defence} ед. урона.')

    def special(self):
        """Метод применения специальных навыков."""
...
def start_training(character: Character) -> str:
    """Функция для осуществления тренировки."""
    commands = {
